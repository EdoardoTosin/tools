...
- *If you want to ask anything about this project, please feel free to open an issue [here](https://github.com/EdoardoTosin/tools/issues).*
...
### *If you would like to provide a fix for a problem you can do so by opening a Pull Request [here](https://github.com/EdoardoTosin/tools/pulls). Below are some points to consider:*
